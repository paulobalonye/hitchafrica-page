...
export default function Hero() {
  return (
    ...
    >
      <Image src={bg1} alt="" className="absolute md:w-2/3 left-0 top-0 h-full z-[-1]" />
      <Image src={bg3} alt="" className="absolute md:w-1/2 right-0 bottom-0 h-1/3 z-[-1]" />
      <div className="flex flex-col gap-5 md:gap-10 items-center text-center">
        ...
        <h3 className="text-[32px] md:text-[64px] text-[#001E1D] font-[800] leading-none">
      ...
      <div className="flex flex-col md:grid grid-cols-4 gap-10 py-10 text-[#434A54] px-5 md:px-20 ">
        ...
        <nav className="flex flex-col gap-3 text-lg md:text-xl">
          <b className="text-[32px] md:text-[36px] text-[#0B1621] font-[700]">15K+</b>
          <p>15k+ users used Dash for their business today.</p>
        </nav>
        <nav className="flex flex-col gap-3 text-lg md:text-xl">
          <b className="text-[32px] md:text-[36px] text-[#0B1621] font-[700]">25%</b>
          <p>Decrease expense more than 25%/mo</p>
        </nav>
        <nav className="flex flex-col gap-3 text-lg md:text-xl">
          <b className="text-[32px] md:text-[36px] text-[#0B1621] font-[700]">60%</b>
