...
export default function Hero() {
  return (
    <div className="relative px-5 md:px-24 py-10 md:py-16 rounded-bl-[100px] md:rounded-bl-[200px] text-white bg-primary w-full flex flex-col md:grid grid-cols-2 gap-8 md:gap-20 items-center z-[0]">
      <Image
        src={fline}
        alt=""
      ...
      <figure className="w-full h-full flex flex-col gap-5 justify-center items-center">
        <Image
          src={hero}
          alt=""
          className="h-[60vw] md:h-[unset] object-contain"
        />
      </figure>
    </div>
  );
