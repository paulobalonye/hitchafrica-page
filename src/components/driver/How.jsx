...
export default function How() {
  return (
    <section className="px-3 md:px-24 py-10 md:py-24 flex flex-col gap-7 md:gap-14 z-10">
          ...
          <div className="flex gap-3 md:gap-6 items-start">
            ...
            <div className="w-full flex flex-col gap-4 md:gap-8 ">
              ...
              <p className="md:text-lg text-[#343D48]">
                ...
                delivered, or your home sparkling clean, {`we've`} got you
                covered! Simply browse through our diverse array of services and
                choose the one that perfectly suits your requirements. The power
                of convenience is now in your hands!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex gap-3 md:gap-6 items-start">
            ...
            <div className="w-full flex flex-col gap-4 md:gap-8 ">
              ...
              <p className="md:text-lg text-[#343D48]">
                ...
                back and relax as you effortlessly book your transport,
                delivery, or provider services. Our user-friendly interface
                allows you to choose your preferred payment method, whether{" "}
                {`it's`} through your card, cash, or wallet. Convenience and
                clarity at their finest!
              </p>
            </div>
          </div>
        </div>
