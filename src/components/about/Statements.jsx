...
export default function Statements() {
  return (
    <main className="md:px-24 py-10 md:py-24 flex flex-col gap-5 md:gap-14 z-10">
      ...
      <div className="w-full md:w-2/3 mx-auto flex flex-col md:grid grid-cols-3 justify-center items-center bg-white md:shadow-md rounded-lg">
        <nav className="flex flex-col items-center text-center gap-5 p-10 h-full w-full">
        ...
        <nav className="flex flex-col items-center text-center gap-5 p-10 bg-[#C0D1D2] skew-y-12 md:skew-y-0 md:-skew-x-12  h-full w-full">
          <b className="text-2xl font-[600] text-black -skew-y-12 md:skew-y-0 md:skew-x-12">Vision</b>
          <p className="text-lg -skew-y-12 md:skew-y-0 md:skew-x-12">
