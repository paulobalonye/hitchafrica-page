...
export default function Why() {
  return (
    <main className="px-5 md:px-24 py-10 md:py-24 flex flex-col gap-5 md:gap-14 z-10">
      ...
      <div className="flex flex-col md:flex-row justify-evenly items-center gap-10 text-3xl md:text-[40px] font-[700]  text-primary">
        <nav className="text-center px-5 py-28 h-auto rounded-xl shadow-md w-[90%] md:w-1/4 flex justify-center items-center relative z-0">
