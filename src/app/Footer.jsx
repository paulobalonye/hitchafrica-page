...
export default function Footer() {
  return (
    <footer className="flex flex-col bg-[#000000] relative gap-10 md:gap-20 pt-10 md:pt-20 px-3 md:px-24 font-[400] text-sm md:text-base text-[rgba(255,255,255,0.70)]">
